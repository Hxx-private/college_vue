  ...
  <div>
    <el-container>
      <el-header style="height: 100px">
        <el-row>
          <el-col :span="2" style="line-height:36px"><el-button size="mini" type="success" @click="loadUser" icon="el-icon-refresh">刷新</el-button></el-col>
          <el-col :span="5"><el-input size="small" v-model="searchUserName" style="width:90%;" placeholder="请输入用户名"></el-input></el-col>
          <el-col :span="5"><el-input size="small" v-model="searchName" style="width: 90%;" placeholder="请输入真实姓名"></el-input></el-col>
          <el-col :span="5"><el-input size="small" v-model="searchNumber" style="width: 90%;" placeholder="请输入学号/工号"></el-input></el-col>
          <el-col :span="5"><el-input size="small" v-model="searchSex" style="width: 90%;" placeholder="请输人性别"></el-input></el-col>
        </el-row>
        <el-row >
          <el-col :span="5" :offset="2"><el-input size="small" v-model="searchRoomId" style="width: 90%;" placeholder="请输入宿舍号"></el-input></el-col>
          <el-col :span="5"><el-input size="small" v-model="searchDepart" style="width: 90%;" placeholder="请入所在系"></el-input></el-col>
          <el-col :span="5"><el-input size="small" v-model="searchSpecial" style="width: 90%;" placeholder="请输入所在专业"></el-input></el-col>
          <el-col :span="2" style="line-height:36px;text-align: right"> <el-button size="mini"  @click="searchAll" >查询</el-button></el-col>
          <el-col :span="2" style="line-height:36px;text-align: right"><el-button size="mini"  @click="repetition" >重置</el-button></el-col>
        </el-row>
      </el-header>
...
                        :current-page.sync="pageNum" :page-sizes="[5, 10, 20]" :page-size="pageSize"
